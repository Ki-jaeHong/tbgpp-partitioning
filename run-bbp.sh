...
# FIXME graph_file
graph_file=/home/tslee/jhko/tbgpp-partitioning/bbp/_graphs/ldbc-snb-bbp-sf1000_v22_e28
...
function create_config {
    ...
    echo 'build_db' >> base
	echo 0 >> value
    echo 'storing_inedges' >> base
	echo 0 >> value
    echo 'distribute_inedges_only' >> base
	echo 0 >> value
